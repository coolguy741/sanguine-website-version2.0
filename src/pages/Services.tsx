      ...
      <div className="flex justify-center bg-black text-white md:h-[70vh] p-8 pt-32">
        <div className='my-auto'>
          ...
          <div className="flex flex-wrap justify-center align-middle mt-[30px]">
            <img className="md:h-[13vh] h-[100px] mx-2 my-4 animate-waving-hand" src="/image/organizations/roche.png" alt='roche'/>
            <img className="md:h-[13vh] h-[100px] mx-2 my-4 animate-waving-hand" src="/image/organizations/gsk.png" alt='gsk'/>
            <img className="md:h-[13vh] h-[100px] mx-2 my-4 animate-waving-hand" src="/image/organizations/ucb.png" alt='ucb'/>
            <img className="md:h-[13vh] h-[100px] mx-2 my-4 animate-waving-hand" src="/image/organizations/galderma.png" alt='galderma'/>
            <img className="md:h-[13vh] h-[100px] mx-2 my-4 animate-waving-hand" src="/image/organizations/alcon.png" alt='alcon'/>
          </div>
        </div>
      </div>
